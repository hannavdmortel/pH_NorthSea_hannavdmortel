...
fig.suptitle('TN trend')

ax[0].scatter(df1.YEAR, df1.tn_raw, alpha=0.3, s=8, c='grey')
ax[0].plot(grouped1.index, grouped1.tn_trend, c='xkcd:pink purple')
ax[0].set_title('Wadden Sea', fontsize= 8, loc='right', pad=1)

ax[1].scatter(df2.YEAR, df2.tn_raw, alpha=0.3, s=8, c='grey')
ax[1].plot(grouped2.index, grouped2.tn_trend, c='royalblue')
ax[1].set_title('Nearshore <20 km', fontsize=8, loc='right', pad=1)

ax[2].scatter(df3.YEAR, df3.tn_raw, alpha=0.3, s=8, c='grey')
ax[2].plot(grouped3.index, grouped3.tn_trend, c='xkcd:teal')
ax[2].set_title('Nearshore 20-50 km', fontsize=8, loc='right', pad=1)

ax[3].scatter(df4.YEAR, df4.tn_raw, alpha=0.3, s=8, c='grey')
ax[3].plot(grouped4.index, grouped4.tn_trend, c='xkcd:pink')
...
plt.savefig("figures/TN trend ALL.png")
