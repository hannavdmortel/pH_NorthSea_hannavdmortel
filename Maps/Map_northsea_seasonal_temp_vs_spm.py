...
ax.scatter(northsea_L2.lon_dd, northsea_L2.lat_dd, 
           ...
           linewidth=0.1, edgecolor='grey', label='no data',
           transform=ccrs.PlateCarree())
...
ax.set_title('Seasonal: temperature vs spm')

plt.savefig("C:/Users/hanna/Documents/GitHub/pH-North-Sea/Maps/figures/seasonal_temp_vs_spm.png")
