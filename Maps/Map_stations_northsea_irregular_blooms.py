...
#LOGICAL
northsea["has_irregular_blooms"] = False
for i in range(len(northsea.station_code)):
    if northsea.station_code[i] in irregularblooms:
        northsea.has_irregular_blooms[i] = True
L = northsea.has_irregular_blooms
...
plt.savefig("C:/Users/hanna/Documents/Marine Sciences/NIOZ/CO2 flux and acidification North Sea/Python/Station map/map_stations_northsea_irregularblooms.png")
